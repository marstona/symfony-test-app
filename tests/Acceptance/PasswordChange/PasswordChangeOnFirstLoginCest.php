...
class PasswordChangeOnFirstLoginCest
{
    ...
    public function passwordChangeOnFirstLogin(AcceptanceTester $I)
    {
        $I->wantToTest('whether the user password change is required after first log in');
